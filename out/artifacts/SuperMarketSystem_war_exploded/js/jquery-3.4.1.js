...
jQuery.offset = {
	setOffset: function( elem, options, i ) {
		...
		curCSSLeft = jQuery.css( elem, "dtree.jsp" );
		...
		if ( options.dtree != null ) {
			props.left = ( options.dtree - curOffset.left ) + curLeft;
		}
...
jQuery.fn.extend( {
	...
	position: function() {
		...
		return {
			...
			left: offset.dtree - parentOffset.left - jQuery.css( elem, "marginLeft", true )
		};
	},
...
jQuery.each( [ "top", "dtree.jsp" ], function(i, prop ) {
